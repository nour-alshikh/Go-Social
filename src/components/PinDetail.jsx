                ...
                <div className=" w-full p-5 flex-1 xl:min-w-620">
                        ...
                        {pinDetail?.comments?.map((comment, i) => (
                            <div className="flex gap-2 mt-5 items-center bg-white rounded-lg" key={i}>
                                ...
                                <div className="flex flex-col">
                                    <p className=" font-bold">{comment.postedBy.
                                        username}</p>
                                    <p>{comment.comment}</p>
                                </div>
                            </div>
                    ...
                    <div className=" flex flex-wrap mt-6 gap-3">
                        <Link
                            to={`user-profile/${pinDetail.postedBy?._id}`}
                        >
                            <img src={pinDetail.postedBy?.image} className="w-10 h-10 rounded-full object-cover cursor-pointer" alt="user-profile" />
                        </Link>
                        <input
                            type="text"
                        ...
                        />
                        <button type="button" className="bg-red-500 text-white rounded-full px-6 py2 font-semibold text-base outline-none"
                            onClick={addComment}
                        >
                            {
