    ...
    return (
        <div className='flex gap-2 md:gap-5 w-full mt-5 pb-7'>
            ...
            <div className='flex gap-3'>
                ...
                <Link to='create-pin' className='bg-black rounded-lg w-12 h-12 text-white md:w-14 md:h-12 flex justify-center items-center '>
                    <IoMdAdd fontWeight={700} fontSize={25} />
                </Link>
            </div>
        </div>
    )
